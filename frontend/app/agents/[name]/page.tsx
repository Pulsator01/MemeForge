    ...
    <main className="min-h-screen pt-20 pb-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glassmorphic rounded-xl p-6 mb-8">
          <h2 className="text-xl font-bold mb-4">Token Performance</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={() => router.push(`/chat?agent=${encodeURIComponent(agent.name)}`)}
            className="px-6 py-3 rounded-lg bg-gradient-to-r from-[#32A9FF] to-[#BB40FF] text-white font-bold flex items-center justify-center space-x-2"
          >
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="px-6 py-3 rounded-lg bg-white/10 text-white font-bold flex items-center justify-center space-x-2 border border-white/20"
          >
